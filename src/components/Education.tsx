...
export default function Education() {
  return (
    <section id="education" className="py-12 sm:py-20 bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-gray-800 rounded-lg p-4 sm:p-8 relative overflow-hidden group">
            <div className="absolute top-0 right-0 transform translate-x-8 -translate-y-8 hidden sm:block">
              <GraduationCap
                size={120}
            ...
            <p className="text-purple-400 mb-4 text-sm sm:text-base">Diploma in Digital Technology Development and Design • Aug 2024 - current • Auckland, NZ</p>
            <div className="space-y-6 text-gray-300">
              <div>
                <h4 className="text-base sm:text-lg font-semibold text-purple-400 mb-2">Component 1: Full Stack Developer</h4>
                <ul className="list-disc list-inside space-y-1 sm:space-y-2 text-gray-400 text-sm sm:text-base ml-2 sm:ml-4">
              ...
              <div>
                <h4 className="text-base sm:text-lg font-semibold text-purple-400 mb-2">Component 2: Advanced Full Stack Developer (Cloud & AI)</h4>
                <ul className="list-disc list-inside space-y-1 sm:space-y-2 text-gray-400 text-sm sm:text-base ml-2 sm:ml-4">
